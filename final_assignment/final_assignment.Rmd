...
top5_country <- c("USA", "GBR", "AUS", "CAN", "DEU")
...
Now, we would like to focus on Computing or Tech salaries in the US by gender. 
...
t.test(salary_usd ~ gender, data = salary_in_tech_by_gender)
```
